 ...
 * and call {@link #openCachedUrl(String, ProgressIndicator)} to download small XML files.
 * <p>
...
public class DownloadCache {
     ...
     * {@link #openDirectUrl(String, Header[], ProgressIndicator)}
     ...
     * <p>
     * {@link #openDirectUrl(String, Header[], ProgressIndicator)} can accept customized
     ...
     * @param indicator {@link ProgressIndicator} which is related to this URL
     *                 fetching.
     ...
     * @see #openDirectUrl(String, Header[], ProgressIndicator)
     */
    @NonNull
     ...
     *
     * @param urlString the URL string to be opened.
     * @param indicator {@link ProgressIndicator} which is related to this URL fetching.
     ...
     */
    @NonNull
    public InputStream openCachedUrl(@NonNull String urlString, @NonNull ProgressIndicator indicator)
            throws IOException {
            ...
            if (useCached && checkCache) {
                ...
                if (useCached) {
                    ...
                    if (etag != null || lastMod != null) {
                        ...
                        if (!headers.isEmpty()) {
                            is = downloadAndCache(urlString, indicator, cached, info,
        ...
        return downloadAndCache(urlString, indicator, cached, info,
    ...
    private InputStream downloadAndCache(
        ...
        try {
            Pair<InputStream, URLConnection> r =
                openUrl(urlString, true /*needsMarkResetSupport*/, indicator, headers);
