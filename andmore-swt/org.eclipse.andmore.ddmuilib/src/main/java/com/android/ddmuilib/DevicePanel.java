...
/**
 * OBSOLETE - Replaced by DevicesPanel. Retained for purpose of possibly restoring old tools.
...
public final class DevicePanel extends Panel implements IDebugBridgeChangeListener,
    ...
    private final static String PREFS_COL_THREAD = "devicePanel.Col2"; //$NON-NLS-1$
    private final static String PREFS_COL_HEAP = "devicePanel.Col3"; //$NON-NLS-1$
    ...
    protected Control createControl(Composite parent) {
        ...
        TableHelper.createTreeColumn(mTree, "   ", SWT.NONE, //$NON-NLS-1$
                "    ", //$NON-NLS-1$
                PREFS_COL_THREAD, store);
        TableHelper.createTreeColumn(mTree, "   ", SWT.NONE, //$NON-NLS-1$
                "    ", //$NON-NLS-1$
                PREFS_COL_HEAP, store);
        TableHelper.createTreeColumn(mTree, "   ", SWT.LEFT, //$NON-NLS-1$
                "9999-9999", //$NON-NLS-1$
