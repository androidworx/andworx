...
final class EventValueSelector extends Dialog {
     ...
     */
    boolean open(Class<? extends DisplayDescriptor> descriptorClass,
            EventLogParser logParser) {
        try {
            DisplayDescriptor descriptor = descriptorClass.newInstance();
            setModified();
     ...
     */
    boolean open(DisplayDescriptor descriptor, EventLogParser logParser) {
        ...
        if (descriptor instanceof ValueDisplayDescriptor) {
            ...
            mDescriptor = new OccurrenceDisplayDescriptor((OccurrenceDisplayDescriptor)descriptor);
        } else {
            return false;
        }
