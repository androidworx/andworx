...
public class RuleLoader {
     ...
     */
    private final static QualifiedName RULE_LOADER = new QualifiedName(AndmoreAndroidConstants.ANDMORE_ID,
    ...
    private ClassLoader computeUserClassLoader(IProject project) {
        ...
        /* TODO - Fix PROPERTY_RULES_PATH
        PolyglotAgent polyglotAgent = AndroidMavenPlugin.getDefault().getMavenServices().getPolyglotAgent();
        ProjectProfile projectProfile = polyglotAgent.getProjectProfile(project);
        String path = projectProfile.getProperty(
