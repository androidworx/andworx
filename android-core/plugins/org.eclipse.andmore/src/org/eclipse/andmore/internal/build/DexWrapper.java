...
public final class DexWrapper {
    ...
    public synchronized IStatus loadDex(String osFilepath) {
        try {
            ...
            if (f.isFile() == false) {
                return new Status(IStatus.ERROR, AndmoreAndroidConstants.PLUGIN_ID, String.format(
    ...
    private static IStatus createErrorStatus(String message, Throwable e) {
        ...
        return new Status(IStatus.ERROR, AndmoreAndroidConstants.PLUGIN_ID, message, e);
    }
}
