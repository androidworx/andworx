...
class XmlPropertyEditor extends AbstractTextPropertyEditor {
    ...
    public void paint(Property property, GC gc, int x, int y, int width, int height)
        ...
        if (text != null) {
            ...
            if (text.startsWith("@") || text.startsWith("?")) { //$NON-NLS-1$ //$NON-NLS-2$
            	...
            	ResourceUrl resourceUrl = ResourceUrl.create(APP_NAMESPACE, ResourceType.COLOR, property.getName());
                resValue = new ResourceValue(resourceUrl, text, null);
            }
    ...
    private final static QualifiedName CACHE_NAME = new QualifiedName(AndmoreAndroidConstants.ANDMORE_ID,
