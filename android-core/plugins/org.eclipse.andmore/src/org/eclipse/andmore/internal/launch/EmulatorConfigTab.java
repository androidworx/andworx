...
public class EmulatorConfigTab extends AbstractLaunchConfigurationTab {
    ...
    public void createControl(Composite parent) {
        ...
        try {
            ...
            if (env.isValid()) {
                AvdManager avdMan = objectFactory.getAvdManager();
                assert avdMan != null;
    ...
    private void updateAvdList(AvdManager avdManager) {
        if (avdManager == null) {
            ...
            if (!env.isValid()) 
				throw new IllegalStateException("AvdManager not available");
            avdManager = objectFactory.getAvdManager();
        }
    ...
    public void initializeFrom(ILaunchConfiguration configuration) {
        ...
        // update the AVD list
        if (project != null) {
            mProjectTarget = AndworxFactory.instance().getTarget(project);
