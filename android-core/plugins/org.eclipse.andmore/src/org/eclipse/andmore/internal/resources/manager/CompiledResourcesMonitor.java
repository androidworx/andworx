 ...
 */
public final class CompiledResourcesMonitor implements IFileListener, IProjectListener, ProjectStateListener {
    ...
    private CompiledResourcesMonitor() {
        ...
        projectRegistry.addProjectListener(this);
    }
    ...
    public void fileChanged(@NonNull IFile file, @NonNull IMarkerDelta[] markerDeltas,
        ...
        if (file.getName().equals(SdkConstants.FN_COMPILED_RESOURCE_CLASS)) {
            ...
            String className = getRClassName(projectRegistry.getProjectState(project));
            if (className == null) {
                // We need to abort.
    ...
    public void projectOpenedWithWorkspace(IProject project) {
    	if (projectRegistry.hasProjectState(project))
    		onProjectOpened(projectRegistry.getProjectState(project));
    	/*
        try {
	...
	public void onProjectOpened(ProjectState projectState) {
        String className = getRClassName(projectState);
     ...
     */
    private String getRClassName(ProjectState projectState) {
    	String javaPackage = projectState.getOriginalApplicationId();
