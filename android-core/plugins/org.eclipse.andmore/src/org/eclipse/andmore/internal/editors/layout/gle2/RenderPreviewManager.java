...
public class RenderPreviewManager {
    ...
    public boolean recomputePreviews(boolean force) {
        ...
        RenderPreviewMode newMode = adtPrefs.getRenderPreviewMode();
    ...
    public void addScreenSizePreviews() {
        ...
        for (int i = 0, n = sorted.size(); i < n; i++) {
            ...
            if (device.getDisplayName().startsWith("Nexus ")         //$NON-NLS-1$
                    || device.getDisplayName().endsWith(" Nexus")) { //$NON-NLS-1$
