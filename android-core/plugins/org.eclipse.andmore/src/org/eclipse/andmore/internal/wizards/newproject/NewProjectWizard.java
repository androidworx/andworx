...
public class NewProjectWizard extends BasicNewProjectResourceWizard implements INewWizard {
    ...
    public boolean performFinish() {
        File file = new File(AndmoreAndroidPlugin.getDefault().getOsSdkFolder(), OS_SDK_TOOLS_LIB_FOLDER + File.separator
    ...
    public IWizardPage getNextPage(IWizardPage page) {
        if (page == mNamePage) {
            ...
            if (mValues.getMode() == Mode.SAMPLE) {
                return mSamplePage;
            } else if (mValues.getMode() != Mode.TEST) {
