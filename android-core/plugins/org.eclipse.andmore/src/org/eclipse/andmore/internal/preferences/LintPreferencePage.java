...
public class LintPreferencePage extends PropertyPage implements IWorkbenchPreferencePage,
    ...
    private void loadSettings(boolean refresh) {
        if (mCheckExportCheckbox != null) {
            ...
            mCheckFileCheckbox.setSelection(adtPrefs.isLintOnSave());
            mCheckExportCheckbox.setSelection(adtPrefs.isLintOnExport());
        }
    ...
    private void storeSettings() {
        ...
        if (mCheckExportCheckbox != null) {
    		AdtPrefs adtPrefs = AndmoreAndroidPlugin.getDefault().getAdtPrefs();
            adtPrefs.setLintOnExport(mCheckExportCheckbox.getSelection());
            adtPrefs.setLintOnSave(mCheckFileCheckbox.getSelection());
        }
