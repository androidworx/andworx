...
import com.android.sdklib.build.legacy.DebugKeyProvider;
import com.android.sdklib.build.legacy.DebugKeyProvider.KeytoolException;
...
public final class AdtPrefs extends AbstractPreferenceInitializer {
    ...
    public final static String PREFS_SDK_DIR = AndmoreAndroidConstants.ANDMORE_ID + ".sdk"; //$NON-NLS-1$

    public final static String PREFS_BUILD_RES_AUTO_REFRESH = AndmoreAndroidConstants.ANDMORE_ID + ".resAutoRefresh"; //$NON-NLS-1$

    public final static String PREFS_BUILD_FORCE_ERROR_ON_NATIVELIB_IN_JAR = AndmoreAndroidConstants.ANDMORE_ID + ".forceErrorNativeLibInJar"; //$NON-NLS-1$

    public final static String PREFS_BUILD_SKIP_POST_COMPILE_ON_FILE_SAVE = AndmoreAndroidConstants.ANDMORE_ID + ".skipPostCompileOnFileSave"; //$NON-NLS-1$

    public final static String PREFS_BUILD_VERBOSITY = AndmoreAndroidConstants.ANDMORE_ID + ".buildVerbosity"; //$NON-NLS-1$

    public final static String PREFS_DEFAULT_DEBUG_KEYSTORE = AndmoreAndroidConstants.ANDMORE_ID + ".defaultDebugKeyStore"; //$NON-NLS-1$

    public final static String PREFS_CUSTOM_DEBUG_KEYSTORE = AndmoreAndroidConstants.ANDMORE_ID + ".customDebugKeyStore"; //$NON-NLS-1$

    public final static String PREFS_HOME_PACKAGE = AndmoreAndroidConstants.ANDMORE_ID + ".homePackage"; //$NON-NLS-1$

    public final static String PREFS_EMU_OPTIONS = AndmoreAndroidConstants.ANDMORE_ID + ".emuOptions"; //$NON-NLS-1$

    public final static String PREFS_MONITOR_DENSITY = AndmoreAndroidConstants.ANDMORE_ID + ".monitorDensity"; //$NON-NLS-1$

    public final static String PREFS_FORMAT_GUI_XML = AndmoreAndroidConstants.ANDMORE_ID + ".formatXml"; //$NON-NLS-1$
    public final static String PREFS_PREFER_XML = AndmoreAndroidConstants.ANDMORE_ID + ".xmlEditor"; //$NON-NLS-1$
    public final static String PREFS_USE_CUSTOM_XML_FORMATTER = AndmoreAndroidConstants.ANDMORE_ID + ".androidForm"; //$NON-NLS-1$

    public final static String PREFS_PALETTE_MODE = AndmoreAndroidConstants.ANDMORE_ID + ".palette"; //$NON-NLS-1$

    public final static String PREFS_USE_ECLIPSE_INDENT = AndmoreAndroidConstants.ANDMORE_ID + ".eclipseIndent"; //$NON-NLS-1$
    public final static String PREVS_REMOVE_EMPTY_LINES = AndmoreAndroidConstants.ANDMORE_ID + ".removeEmpty"; //$NON-NLS-1$
    public final static String PREFS_ONE_ATTR_PER_LINE = AndmoreAndroidConstants.ANDMORE_ID + ".oneAttrPerLine"; //$NON-NLS-1$
    public final static String PREFS_SPACE_BEFORE_CLOSE = AndmoreAndroidConstants.ANDMORE_ID + ".spaceBeforeClose"; //$NON-NLS-1$
    public final static String PREFS_FORMAT_ON_SAVE = AndmoreAndroidConstants.ANDMORE_ID + ".formatOnSave"; //$NON-NLS-1$
    public final static String PREFS_LINT_ON_SAVE = AndmoreAndroidConstants.ANDMORE_ID + ".lintOnSave"; //$NON-NLS-1$
    public final static String PREFS_LINT_ON_EXPORT = AndmoreAndroidConstants.ANDMORE_ID + ".lintOnExport"; //$NON-NLS-1$
    public final static String PREFS_ATTRIBUTE_SORT = AndmoreAndroidConstants.ANDMORE_ID + ".attrSort"; //$NON-NLS-1$
    public final static String PREFS_LINT_SEVERITIES = AndmoreAndroidConstants.ANDMORE_ID + ".lintSeverities"; //$NON-NLS-1$
    public final static String PREFS_FIX_LEGACY_EDITORS = AndmoreAndroidConstants.ANDMORE_ID + ".fixLegacyEditors"; //$NON-NLS-1$
    public final static String PREFS_SHARED_LAYOUT_EDITOR = AndmoreAndroidConstants.ANDMORE_ID + ".sharedLayoutEditor"; //$NON-NLS-1$
    public final static String PREFS_PREVIEWS = AndmoreAndroidConstants.ANDMORE_ID + ".previews"; //$NON-NLS-1$
    public final static String PREFS_SKIP_LINT_LIBS = AndmoreAndroidConstants.ANDMORE_ID + ".skipLintLibs"; //$NON-NLS-1$
    public final static String PREFS_AUTO_PICK_TARGET = AndmoreAndroidConstants.ANDMORE_ID + ".autoPickTarget"; //$NON-NLS-1$
    public final static String PREFS_REFACTOR_IDS = AndmoreAndroidConstants.ANDMORE_ID + ".refactorIds"; //$NON-NLS-1$
    ...
    /**
     * Do NOT use!
     * A default constructor is required by OSGI registry to obtain default values.
     */
    public AdtPrefs() {
    	defaultsOnly = true;
    }

    public AdtPrefs(IPreferenceStore preferenceStore) {
        mStore = preferenceStore;
    }
...
*/
    ...
    public void setLintOnSave(boolean on) {
        mLintOnSave = on;
    	if (!defaultsOnly)
    		mStore.setValue(PREFS_LINT_ON_SAVE, on);
    }
    ...
    public void setLintOnExport(boolean on) {
         mLintOnExport = on;
     	if (!defaultsOnly)
            mStore.setValue(PREFS_LINT_ON_EXPORT, on);
    }
    ...
    public void setSharedLayoutEditor(boolean on) {
    	...
    	if (!defaultsOnly)
            mStore.setValue(PREFS_SHARED_LAYOUT_EDITOR, on);
    ...
    public void setPaletteModes(String palette) {
        mPalette = palette;
    	if (!defaultsOnly)
            mStore.setValue(PREFS_PALETTE_MODE, palette);
    }
    ...
    public void setMonitorDensity(float density) {
    	...
    	if (!defaultsOnly)
            mStore.setValue(PREFS_MONITOR_DENSITY, density);
    }
    ...
    public void setSdkLocation(File location) {
    	...
    	if (!defaultsOnly)
            mStore.setValue(PREFS_SDK_DIR, mOsSdkLocation);
    }
    */
    /**
    ...
    public void setXmlEditorPreferred(int editorType, boolean xml) {
        if (xml != isXmlEditorPreferred(editorType)) {
        	...
        	if (!defaultsOnly)
                mStore.setValue(PREFS_PREFER_XML, xml);
        }
    }
    ...
    public void setPreviewMode(@NonNull RenderPreviewMode previewMode) {
    	...
    	if (!defaultsOnly) {
	        if (previewMode != RenderPreviewMode.NONE) {
	        	mStore.setValue(PREFS_PREVIEWS, previewMode.name().toLowerCase(Locale.US));
	        } else {
	        	mStore.setToDefault(PREFS_PREVIEWS);
	        }
    	}
    }
    ...
    public void setAutoPickRenderTarget(boolean autoPick) {
    	...
    	if (!defaultsOnly) {
	        if (autoPick) {
	            mStore.setToDefault(PREFS_AUTO_PICK_TARGET);
	        } else {
	        	mStore.setValue(PREFS_AUTO_PICK_TARGET, autoPick);
	        }
    	}
    }
    ...
    public void setSkipLibrariesFromLint(boolean exclude) {
        if (exclude != mSkipLibrariesFromLint) {
        	...
        	if (!defaultsOnly) {
	            if (exclude) {
	            	mStore.setValue(PREFS_SKIP_LINT_LIBS, true);
	            } else {
	            	mStore.setToDefault(PREFS_SKIP_LINT_LIBS);
	            }
        	}
        }
    }
    ...
    public void initializeDefaultPreferences() {
    	mBuildForceResResfresh = true;
    	mBuildForceErrorOnNativeLibInJar = true;
    	mBuildSkipPostCompileOnFileSave = true;
    	mBuildVerbosity = BuildVerbosity.ALWAYS;
    	mMonitorDensity = 0.f;
    	mFormatGuiXml = true;
    	mCustomXmlFormatter = true;
    	mOneAttributeOnFirstLine = true;
    	mSpaceBeforeClose = true;
    	mLintOnSave = true;
    	mLintOnExport = true;
    	mAutoPickTarget = true;
    	if (!defaultsOnly) 
            initializeStoreWithDefaults(mStore);
    }

    private void initializeStoreWithDefaults(IPreferenceStore store) {
