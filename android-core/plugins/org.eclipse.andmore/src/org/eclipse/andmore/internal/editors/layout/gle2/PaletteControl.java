...
public class PaletteControl extends Composite {
        ...
        void createToolbarItems(final ToolBar toolbar) {
            ...
            popupMenuItem.addSelectionListener(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent e) {
                    ...
                    mControl.showMenuPrivately(point.x, point.y);
                }
            });
        }
    ...
    private void loadPaletteMode() {
       ...
       String paletteModes = adtPrefs.getPaletteModes();
    ...
    private boolean getSavedAutoCloseMode() {
		AdtPrefs adtPrefs = AndmoreAndroidPlugin.getDefault().getAdtPrefs();
        return !adtPrefs.getPaletteModes().contains(VALUE_NO_AUTOCLOSE);
    }
    ...
    private void savePaletteMode() {
		...
		AdtPrefs adtPrefs = AndmoreAndroidPlugin.getDefault().getAdtPrefs();
        adtPrefs.setPaletteModes(sb.toString());
    }
    ...
    private boolean previewsAvailable() {
        ...
        return layoutLibrary != null && layoutLibrary.supports(Features.CUSTOM_BACKGROUND_COLOR);
    }
    ...
    public void reloadPalette(IAndroidTarget target) {
        ...
        AndroidTargetData targetData =
            (currentSdk != null && target != null) ? currentSdk.getTargetData(target) : null;
    ...
    private class DescDragSourceListener implements DragSourceListener {
        ...
        private Pair<Image, Rectangle> renderPreview() {
            ...
            if (layoutLibrary != null &&
                    layoutLibrary.supports(Features.CUSTOM_BACKGROUND_COLOR)) {
                ...
                overrideBgColor = Integer.valueOf(0x00FF0000);
            }
    ...
    private void addMenu(Control control) {
        control.addMenuDetectListener(new MenuDetectListener() {
            ...
            public void menuDetected(MenuDetectEvent e) {
                showMenuPrivately(e.x, e.y);
            }
        });
    }

    private void showMenuPrivately(int x, int y) {
