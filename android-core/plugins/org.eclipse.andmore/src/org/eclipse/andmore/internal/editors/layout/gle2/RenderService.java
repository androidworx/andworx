...
public class RenderService {
    ...
    private RenderSecurityManager createSecurityManager() {
        ...
        File sdkPath = new File(""); // Prevent NPE
        if (RenderSecurityManager.RESTRICT_READS) {
            ...
            sdkPath = env.isValid() ? env.getAndroidSdkHandler().getLocation() : null;
        }
        RenderSecurityManager securityManager = new RenderSecurityManager(sdkPath.getPath(), projectPath);
    ...
    public RenderSession createRenderSession() {
            ...
            if (contextLayout != null) {
                ...
                if (layoutFile.isFile()) {
                    try {
                        ...
                        String xmlText = Files.asCharSource(layoutFile, Charsets.UTF_8).read();
        ...
        try {
            ...
            mLogger.error(null, t.getLocalizedMessage(), t, null, null);
            throw t;
        } finally {
    ...
    public Map<INode, Rect> measureChildren(INode parent,
        ...
        try {
            ...
            if (session.getResult().isSuccess() && session.measure().isSuccess()) {
