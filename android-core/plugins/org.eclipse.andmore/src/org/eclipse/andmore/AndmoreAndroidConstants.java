...
public class AndmoreAndroidConstants {
    /** The AndmoreAndroidPlugin plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.andworx"; //$NON-NLS-1$
    ...
    public static final String ANDMORE_ID = "org.eclipse.andmore"; //$NON-NLS-1$
    ...
    public final static String MARKER_ADT = ANDMORE_ID + ".adtProblem"; //$NON-NLS-1$
    ...
    public final static String MARKER_TARGET = ANDMORE_ID + ".targetProblem"; //$NON-NLS-1$
    /** Marker for Android Build Tools errors.
     * This is not cleared on each build like other markers. Instead, it's cleared
     * when the build tools are setup in the projectState. */
    public final static String MARKER_BUILD_TOOLS = ANDMORE_ID + ".buildToolsProblem"; //$NON-NLS-1$
    ...
    public final static String MARKER_DEPENDENCY = ANDMORE_ID + ".dependencyProblem"; //$NON-NLS-1$
    ...
    public final static String MARKER_PACKAGING = ANDMORE_ID + ".packagingProblem"; //$NON-NLS-1$

    /** manifest merger error, only to be used in {@link PreCompilerBuilder} */
    public final static String MARKER_MANIFMERGER = ANDMORE_ID + ".manifMergerProblem"; //$NON-NLS-1$

    /** Marker for lint errors */
    public final static String MARKER_LINT = ANDMORE_ID + ".lintProblem"; //$NON-NLS-1$
     ...
     */
    public final static String COMPILER_COMPLIANCE_PREFERRED = JavaCore.VERSION_1_8;
	...
	/** Title logo */
    public static final String PROJECT_LOGO_LARGE = "icons/android-64.png";
}
