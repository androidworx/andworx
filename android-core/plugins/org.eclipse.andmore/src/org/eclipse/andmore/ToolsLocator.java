...
public class ToolsLocator implements IToolsLocator {
    ...
    public String getAdbLocation() {
        return AndmoreAndroidPlugin.getDefault().getOsAbsoluteAdb();
    }

    @Override
    public String getHprofConvLocation() {
        return AndmoreAndroidPlugin.getDefault().getOsAbsoluteHprofConv();
    }

    @Override
    public String getTraceViewLocation() {
        return AndmoreAndroidPlugin.getDefault().getOsAbsoluteTraceview();
    }
}
