...
import com.android.sdklib.build.legacy.SignedJarBuilder.IZipEntryFilter.ZipAbortException;
...
public class SignedJarBuilder {
    ...
    private void writeSignatureBlock(Signature signature, X509Certificate publicKey,
        ...
        pkcs7.encodeSignedData(mOutputJar); // Encodes the signed data to a DerOutputStream
        /*
