...
import static org.eclipse.andworx.api.attributes.AndroidArtifacts.PublishedConfigType.API_ELEMENTS;
import static org.eclipse.andworx.api.attributes.AndroidArtifacts.PublishedConfigType.METADATA_ELEMENTS;
import static org.eclipse.andworx.api.attributes.AndroidArtifacts.PublishedConfigType.RUNTIME_ELEMENTS;
...
public class AndroidArtifacts {
	 ...
	 * @since 4.0
	 */
	public interface ArtifactTypeDefinition {
	    /**
    ...
    //public static final StringAttribute ARTIFACT_TYPE = Attribute.of("artifactType");
