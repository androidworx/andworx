...
/**
 * Generate query to find an entity object by primary key
 */
public class EntityByPrimaryKeyGenerator implements DaoQueryFactory {
    ...
    {   // Only one select argument required for primary key 
        final SimpleSelectArg primaryKeyArg = new SimpleSelectArg();
        // Set primary key column name
        primaryKeyArg.setMetaInfo("id");
        return new DaoQuery<T>(dao, primaryKeyArg){
