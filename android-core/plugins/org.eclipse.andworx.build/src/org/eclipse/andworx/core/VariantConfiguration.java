...
//import org.eclipse.andworx.core.VariantType;
 ...
 */
public class VariantConfiguration<D extends ProductFlavor> {
    ...
    @NonNull
    private final BuildTypeImpl mBuildType;
    @Nullable
    private VariantType testedType;
     ...
     */
    private VariantConfiguration<D> mTestedConfig;
     ...
     */
    private final Map<String, ClassField> mBuildConfigFields = new TreeMap<>();

    /**
     * Variant-specific res values.
     */
    private final Map<String, ClassField> mResValues = new TreeMap<>();

    /**
     * Signing Override to be used instead of any signing config provided by Build Type or
     * Product Flavors.
     */
    private SigningConfig mSigningConfigOverride;
    ...
    @NonNull private ManifestAttributeSupplier mManifestAttributeSupplier;

	/**
	 * Construct  VariantConfiguration object
    ...
    public VariantConfiguration(
        ...
        @NonNull VariantType type)
        {
    		...
    		// Default RemoveUnusedCode to true
    		postprocessingOptions.setRemoveUnusedCode(true);
    }
     ...
     */
    public VariantConfiguration<D> setVariantSourceProvider(@Nullable SourceProvider sourceProvider) {
    ...
    @Nullable
    public VariantType getTestedType() {
        return testedType;
    }
    ...
    @Nullable
    public VariantConfiguration<D> getTestedConfig() {
    ...
    public String getInstrumentationRunner() {
        VariantConfiguration<D> config = this;
        if (mType.isForTesting()) {
    ...
    public int getRenderscriptTarget() {
        int targetApi = mMergedFlavor.getRenderscriptTargetApi() != null ?
                mMergedFlavor.getRenderscriptTargetApi() : -1;
    ...
    public Map<String, ClassField> getMergedBuildConfigFields() {
        Map<String, ClassField> mergedMap = new HashMap<>();
